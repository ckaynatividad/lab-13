const tsundere = {
    ...
    choices: [{
        ...
        result: 
        `After she finishes talking, you stare at her for a moment before walking away. She gets upset you did not acknowledge her, and decides to kick you. love -20, confidence +0`,
        love: -20,
        confidence: 0
    }]
};
...
const yandere = {
    ...
    choices: [{
        ...
        result: 
        `In response, you snap at her to watch where she is going next time. She giggles again as if you've handed her a compliment. "Okay!" She says, but you do not feel any sense of satisfaction. You walk away, confused and a little disturbed. love +1, confidence -10`,
        love: 1,
        confidence: -10
    }, {
        id: 'apologize',
        description: 'Apologize immediately',
        result: 
        `You immediately apologize while picking up her books. She seems grateful, and thanks you before quietly giggling and leaving. You feel a little confused, but strangely memorized by her. love +20, confidence +10`,
        love: 20,
        confidence: 10
    }, {
        id: 'ignore',
...
const kuudere = {
    ...
    choices: [{
        ...
        result:
        `You apologize and immediately bend down to pick up her book. She stops you, and says "It's fine." She picks it up herself and walks away without looking at you. You feel embarrassed. But there's just something about her.. love +0, confidence -10`,
        love: 0,
        confidence: -10
...
const dandere = {
    ...
    choices: [{
        ...
        description: 'Snap at her',
        result: 
        `You snap, "Watch where you're going." She is taken aback by your words, before you realize tears are starting to well up in her eyes. She says sorry again before quickly leaving as a tear reluctantly falls down her face. You can feel her anxiety and embarrassment as she leaves, and you feel bad. love -30, confidence -10`,
        love: -30,
        confidence: -10
    }, {
        id: 'apologize',
        description: 'Apologize',
        result: 
        `You apologize and reassure her that it was your fault for bumping into her. She looks embarrassed, but slightly soothed by your words. Upon realizing this, she tenses up again and apologizes before running away. love +20, confidence +10`,
        love: 20,
        confidence: 10
    }, {
        id: 'ignore',
